...
//
//	private static final String URL_API = "http://restapi.amap.com/v3/geocode/regeo?key=%s&location=%s"; //高德地图web服务地理/逆地理编码接口
    ...
    */ 
    public Double[] getCoordinate(String addr) throws IOException { 
        ...
        String URL_API = String .format("http://api.map.baidu.com/geocoder?address=%s&output=json&key=%s", address, key); 
        URL myURL = null; 
        URLConnection httpsConn = null; 
        try { 
            myURL = new URL(URL_API); 
