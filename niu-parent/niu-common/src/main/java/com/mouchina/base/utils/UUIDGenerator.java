...
public class UUIDGenerator {
	...
	public static Long userIdGenerator(RedisHelper redisHelper) {
		 ...
		 * 用户全局唯一idKey
		 */
		String GLOBLLYUNIQUE_USERID_KEY = RedisHelper.RedisKeyPrefix.GLOBAL_UNIQUE_USERID_KEY.toString();
	 ...
	 * @return
	 */
	public static String createGlobalUniquePayNo(RedisHelper redisHelper) {
		String orderNo = "";
		String key = DateUtils.getPayNowDateStringNo();

		Long sequence = redisHelper.getIncr(RedisHelper.RedisKeyPrefix.GLOBAL_UNIQUE_PAY_NO_KEY.toString() + key);
	 ...
	 * @return
	 */
	public static String createGlobalUniqueOrderNo(RedisHelper redisHelper) {
		String orderNo = "";
		String key = DateUtils.getPayNowDateStringNo();

		Long sequence = redisHelper.getIncr(RedisHelper.RedisKeyPrefix.GLOBAL_UNIQUE_ORDER_NO_KEY.toString() + key);
	 ...
	 * @return
	 */
	public static String getGlobalUniqueInviteCode(RedisHelper redisHelper) {
		String globalUniqueInviteCode = RedisHelper.RedisKeyPrefix.GLOBAL_UNIQUE_INVITE_CODE_KEY.toString();
		int baseLength = 8;
		int baseKey = 1;
		Long sequence = redisHelper.getIncr(globalUniqueInviteCode);
		Long invoteCode = baseKey + sequence;
		String inviteCodeStr = invoteCode + "";
