...
public class NumberUtil {
	...
	/**
	 * 返回随机数0.06~0.16(首页红包随机数用)
	 * @return
	 */
	public static double getHomePageRandomNumber(){
		double a = ((10 * Math.random()) + 6)/100;
		return a;
	}
	
	/**
	 * 返回随机数0.06~0.33(首页分享红包随机数用)
	 * @return
	 */
	public static double getShareHomePageRandomNumber(){
		double a = ((27 * Math.random()) + 6)/100;
		return a;
	}
